...
! 
! !DESCRIPTION:  
!   Returns $f = true$ if the irreducible representations of the 
!   space group $\mathcal{G}({\bf k})$ of the allowed {\bf k}-vector can be  
!   represented by the irreducible representations of the 
