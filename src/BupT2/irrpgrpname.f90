...
! !ROUTINE: irrpgrname 
! !INTERFACE:  
subroutine irrpgrpname(nsym,lkgrp,irot,tran,name) 
! !USES: 
use modmain  
! !INPUT/OUTPUT PARAMETERS: 
!   nsym  : number of crystal symmetry operations    (in, integer) 
!   irot  : symmetry rotations Rg                    (in ,integer(3,3,48)) 
!   tran  : symmetry translations tg                 (in ,real(3,48)) 
!   name  : point group name where columns           (out,character(2))  
...
nrot(1:10)=0 
do is=1,nsym 
  rot(1:3,1:3)=dble(symcryss(1:3,1:3,lkgrp(is))) 
  det =r3mdet(rot) 
  ros(1:3,1:3)=0.0 
  ros(1,1)    =1.0 
  ros(2,2)    =1.0 
...
case('10000 01000')   
  name(1:2)(1:5) = (/'Cs   ','m    '/) 
case('11000 11000')   
  name(1:2)(1:5) = (/'C2h  ','2/m  '/)   
case('13000 00000')   
  name(1:2)(1:5) = (/'D2   ','222  '/) 
case('11000 02000')   
  name(1:2)(1:5) = (/'C2v  ','mm2  '/)      
case('13000 13000')   
  name(1:2)(1:5) = (/'D2h  ','mmm  '/) 
case('11020 00000')   
  name(1:2)(1:5) = (/'C4   ','4    '/) 
case('11000 00020')   
  name(1:2)(1:5) = (/'S4   ','-4   '/) 
case('11020 11020')   
  name(1:2)(1:5) = (/'C4h  ','4/m  '/) 
case('15020 00000')   
  name(1:2)(1:5) = (/'D4   ','422  '/) 
case('11020 04000')   
  name(1:2)(1:5) = (/'C4v  ','4mm  '/) 
case('13000 02020')   
  name(1:2)(1:5) = (/'D2d  ','-42m '/) 
case('15020 15020')   
  name(1:2)(1:5) = (/'D4h  ','4/mmm'/) 
case('10200 00000')   
  name(1:2)(1:5) = (/'C3   ','3    '/) 
case('10200 10200')   
  name(1:2)(1:5) = (/'C3i  ','-3   '/) 
...
case('10200 01002')   
  name(1:2)(1:5) = (/'C3h  ','-6   '/) 
case('11202 11202')   
  name(1:2)(1:5) = (/'C6h  ','6/m  '/) 
case('17202 00000')   
  name(1:2)(1:5) = (/'D6   ','622  '/) 
case('11202 06000')   
  name(1:2)(1:5) = (/'C6v  ','6mm  '/) 
case('13200 04002')   
  name(1:2)(1:5) = (/'D3h  ','-6m2 '/) 
case('17202 17202')   
  name(1:2)(1:5) = (/'D6h  ','6/mmm'/) 
case('13800 00000')   
  name(1:2)(1:5) = (/'T    ','23   '/) 
case('13800 13800')   
  name(1:2)(1:5) = (/'Th   ','m-3  '/) 
...
case('13800 06060')   
  name(1:2)(1:5) = (/'Td   ','-43m '/) 
case('19860 19860')   
  name(1:2)(1:5) = (/'Oh   ','m-3m '/) 
case default 
  write(*,*) 
  write(*,'("Error(findpgrpname): not found point group")') 
  write(*,*) 
  stop  
end select   
return 
